          ...
          <div className="hidden md:flex items-center gap-1 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
            {[
              ...
              <button 
                ...
                className="px-5 py-2 rounded-full text-[13px] font-semibold text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white hover:bg-slate-100/50 dark:hover:bg-slate-800/50 transition-all duration-300 ease-luxury btn-press"
              >
                {item.label}
              </button>
            ))}
          ...
          <div className="flex items-center gap-2">
            ...
            >
             ...
             <button 
              ...
              className="bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 py-2.5 rounded-full text-[13px] font-bold hover:bg-black dark:hover:bg-slate-200 transition-all duration-300 ease-luxury btn-press shadow-lg shadow-slate-900/20 dark:shadow-white/10 hover:shadow-xl"
            >
              Order Now
            </button>
            <button 
